        ...
        <div>
          <form action="Student/extra/login.php" method="post" enctype='multipart/form-data'>
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-5">
                <input type="password" class="form-control" name="pass" id="inputpass" required>
              </div>
            </div>
      ...
      <center>
        <div>
          <form action="Admin/extra/login.php" method="post" enctype='multipart/form-data'>
            ...
            <br>
            <div class="form-group row">
              <label for="inputapass" class="col-sm-5 col-form-label"><b>Password: </b></label>
              <div class="col-sm-5">
                <input type="password" class="form-control" name="passwd" id="inputapass" required>
              </div>
            </div>
            <input type="checkbox" onclick="myFunction('inputapass')">  Show Password
            <br>
            <div class="row">
              <div class="col-md-6">
